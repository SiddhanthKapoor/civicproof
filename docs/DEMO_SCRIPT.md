...
| 0:40–1:20 | Case page, **investigation streaming** | "This is Claude on Amazon Bedrock, running as a Strands agent. It finds the project at this spot, reads the official records, and records each fact with a quotation. Every tool call passes a Cedar policy first." Point at a verified line and, if it appears, a rejected or denied line. |
